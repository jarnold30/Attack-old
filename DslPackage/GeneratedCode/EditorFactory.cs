...
namespace JA.Attack
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.AttackEditorFactoryId)]
	internal partial class AttackEditorFactory : AttackEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new AttackEditorFactory.
		/// </summary>
		public AttackEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class AttackEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected AttackEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new AttackDocData(this.ServiceProvider, typeof(AttackEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new AttackDocView(docData, this.ServiceProvider);
		}
	}
}
