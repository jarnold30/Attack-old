...
namespace JA.Attack
{
	...
	[DslModeling::DomainObjectId("af694210-0c18-4760-8ae4-6e4d8bf4131a")]
	public partial class AttackDiagram : DslDiagrams::Diagram
	{
		...
		protected override DslDiagrams::ShapeElement CreateChildShape(DslModeling::ModelElement element)
		{
			...
			{
				global::JA.Attack.MergeBranchShape newShape = new global::JA.Attack.MergeBranchShape(this.Partition);
			...
			if(element is global::JA.Attack.Synchronization)
			{
				global::JA.Attack.SyncBarShape newShape = new global::JA.Attack.SyncBarShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			...
			if(element is global::JA.Attack.Flow)
			{
		...
		private global::JA.Attack.FlowConnectAction flowConnectAction;
		/// <summary>
		...
		public override void OnViewMouseEnter(DslDiagrams::DiagramPointEventArgs pointArgs)
		{
			...
			if(activeView != null)
			{
				...
				if (SelectedToolboxItemSupportsFilterString(activeView, global::JA.Attack.AttackToolboxHelper.FlowFilterString))
				{
					if (this.flowConnectAction == null)
					{
						this.flowConnectAction = new global::JA.Attack.FlowConnectAction(this);
		...
		/// </summary>
		public static readonly new global::System.Guid DomainClassId = new global::System.Guid(0xaf694210, 0x0c18, 0x4760, 0x8a, 0xe4, 0x6e, 0x4d, 0x8b, 0xf4, 0x13, 0x1a);
		/// <summary>
		/// Constructor
		/// </summary>
...
namespace JA.Attack
{
		...
		[DslModeling::RuleOn(typeof(global::JA.Attack.Synchronization), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddShapeParentExistRulePriority, InitiallyDisabled=true)]
		...
		[DslModeling::RuleOn(typeof(global::JA.Attack.Flow), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddConnectionRulePriority, InitiallyDisabled=true)]
		internal sealed partial class FixUpDiagram : FixUpDiagramBase
		{
			...
			public override void ElementAdded(DslModeling::ElementAddedEventArgs e)
			{
				...
				if(childElement is global::JA.Attack.Synchronization)
				{
					parentElement = GetParentForSynchronization((global::JA.Attack.Synchronization)childElement);
				} else
			...
			public static global::JA.Attack.AttackGraph GetParentForSynchronization( global::JA.Attack.FlowElement root )
			{
				// Segments 0 and 1
				global::JA.Attack.AttackGraph result = root.AttackGraph;
				if ( result == null ) return null;
		...
		internal sealed class CompartmentItemAddRule : DslModeling::AddRule
		{
			...
			internal static global::System.Collections.ICollection GetTaskForTaskShapePreConditions(global::JA.Attack.Condition root)
			{
				// Segments 1 and 0
				global::JA.Attack.Task result = root.Task;
				if ( result == null ) return new DslModeling::ModelElement[0];
			...
			internal static global::System.Collections.ICollection GetStateForStateShapePostConditions(global::JA.Attack.Condition root)
			{
				// Segments 1 and 0
				global::JA.Attack.State result = root.State;
				if ( result == null ) return new DslModeling::ModelElement[0];
		...
		/// </summary>
		[DslModeling::RuleOn(typeof(global::JA.Attack.Condition), FireTime=DslModeling::TimeToFire.TopLevelCommit, InitiallyDisabled=true)]
		internal sealed class CompartmentItemChangeRule : DslModeling::ChangeRule 
		{
			...
			{
				if(e==null) throw new global::System.ArgumentNullException("e");
				if(e.ModelElement is global::JA.Attack.Condition && e.DomainProperty.Id == global::JA.Attack.Condition.NameDomainPropertyId)
				{
					global::System.Collections.IEnumerable elements = CompartmentItemAddRule.GetTaskForTaskShapePreConditions((global::JA.Attack.Condition)e.ModelElement);
					CompartmentItemAddRule.UpdateCompartments(elements, typeof(global::JA.Attack.TaskShape), "PreConditions", repaintOnly);
				}
				if(e.ModelElement is global::JA.Attack.Condition && e.DomainProperty.Id == global::JA.Attack.Condition.NameDomainPropertyId)
				{
					global::System.Collections.IEnumerable elements = CompartmentItemAddRule.GetStateForStateShapePostConditions((global::JA.Attack.Condition)e.ModelElement);
					CompartmentItemAddRule.UpdateCompartments(elements, typeof(global::JA.Attack.StateShape), "PostConditions", repaintOnly);
				}
			}
		}
		...
		internal sealed class CompartmentItemRolePlayerChangeRule : DslModeling::RolePlayerChangeRule 
		{
			...
			internal static void RolePlayerChanged(DslModeling::RolePlayerChangedEventArgs e, bool repaintOnly)
			{
				...
				if(typeof(global::JA.Attack.TaskHasPreConditions).IsAssignableFrom(e.DomainRelationship.ImplementationClass))
				{
					...
					{
						//global::System.Collections.IEnumerable oldElements = CompartmentItemAddRule.GetTaskForTaskShapePreConditionsFromLastLink((global::JA.Attack.Condition)e.OldRolePlayer);
					...
					{
						global::System.Collections.IEnumerable elements = CompartmentItemAddRule.GetTaskForTaskShapePreConditions((global::JA.Attack.Condition)e.NewRolePlayer);
						CompartmentItemAddRule.UpdateCompartments(elements, typeof(global::JA.Attack.TaskShape), "PreConditions", repaintOnly);
					}
				}
				if(typeof(global::JA.Attack.StateHasPostConditions).IsAssignableFrom(e.DomainRelationship.ImplementationClass))
				{
					if(e.DomainRole.IsSource)
					{
						//global::System.Collections.IEnumerable oldElements = CompartmentItemAddRule.GetStateForStateShapePostConditionsFromLastLink((global::JA.Attack.Condition)e.OldRolePlayer);
						//foreach(DslModeling::ModelElement element in oldElements)
						//{
						//	DslModeling::LinkedElementCollection<DslDiagrams::PresentationElement> pels = DslDiagrams::PresentationViewsSubject.GetPresentation(element);
						//	foreach(DslDiagrams::PresentationElement pel in pels)
					...
					{
						global::System.Collections.IEnumerable elements = CompartmentItemAddRule.GetStateForStateShapePostConditions((global::JA.Attack.Condition)e.NewRolePlayer);
						CompartmentItemAddRule.UpdateCompartments(elements, typeof(global::JA.Attack.StateShape), "PostConditions", repaintOnly);
					}
				}
			}
		...
		internal sealed class CompartmentItemRolePlayerPositionChangeRule : DslModeling::RolePlayerPositionChangeRule 
		{
			...
			internal static void RolePlayerPositionChanged(DslModeling::RolePlayerOrderChangedEventArgs e, bool repaintOnly)
			{
				...
				if(typeof(global::JA.Attack.TaskHasPreConditions).IsAssignableFrom(e.DomainRelationship.ImplementationClass))
				{
					...
					{
						global::System.Collections.IEnumerable elements = CompartmentItemAddRule.GetTaskForTaskShapePreConditions((global::JA.Attack.Condition)e.CounterpartRolePlayer);
						CompartmentItemAddRule.UpdateCompartments(elements, typeof(global::JA.Attack.TaskShape), "PreConditions", repaintOnly);
					}
				}
				if(typeof(global::JA.Attack.StateHasPostConditions).IsAssignableFrom(e.DomainRelationship.ImplementationClass))
				{
					if(!e.CounterpartDomainRole.IsSource)
					{
						global::System.Collections.IEnumerable elements = CompartmentItemAddRule.GetStateForStateShapePostConditions((global::JA.Attack.Condition)e.CounterpartRolePlayer);
						CompartmentItemAddRule.UpdateCompartments(elements, typeof(global::JA.Attack.StateShape), "PostConditions", repaintOnly);
					}
				}
			}
