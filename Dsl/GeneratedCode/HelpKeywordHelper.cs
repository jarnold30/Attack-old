...
namespace JA.Attack
{
	...
	/// </remarks>
	public partial class AttackHelpKeywordHelper : AttackHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new AttackHelpKeywordHelper.
		/// </summary>
		protected AttackHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the AttackHelpKeywordHelper.
		/// </summary>
		public static AttackHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class AttackHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new AttackHelpKeywordHelperBase.
		/// </summary>
		protected AttackHelpKeywordHelperBase()
			: base() { }
